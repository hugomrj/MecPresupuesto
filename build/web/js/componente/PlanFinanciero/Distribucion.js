...
function meses_valores (  ){
    ...
    AjaxPeticion('../PlanFinanciero/jspf/distribucionMeses.jspx','tab_body');  
    ...
    pfdm_editar.addEventListener('click',
        function() {   
                ...
                AjaxPeticion( '../PlanFinanciero/jspf/agregar_editar.jspx' , 'capa_clara' );            
                dimensionarVentana('capa_clara', 900, 250);                    
                
                var registro = getParametroValor("registro");
                PlanFinanciero_agregar_editar(registro);            
    ...
    ditribucionMeses_destino(modalidad, planf);
