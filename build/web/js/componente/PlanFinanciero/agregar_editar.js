...
function PlanFinanciero_agregar_editar ( registro ){

    
    PlanFinanciero_agregar_editar_json ( registro );

    PlanFinanciero_agregar_editar_campos_interaccion();
    ...
    pafa_aceptar.addEventListener('click',
        function() {
                ...
                var pafa_presupuesto_id = document.getElementById('pafa_presupuesto_id');
                pafa_presupuesto_id.value = registro;
                ...
                if (PlanFinanciero_agregar_editar_validacion()){
                    if (control == null){    
                        meses_valores (  ) ;
                        pafa_cerrar.click();
                    }
...
function PlanFinanciero_agregar_editar_validacion (  ){
        ...
        if (diferencia < 0){
            alerta_error("Error en diferencia con distribucion del plan financiero y el presupuesto vigente");
            return false
        }
...
function PlanFinanciero_agregar_editar_campos_interaccion ( )
{
...
function PlanFinanciero_agregar_editar_json ( registro )
{

    var jsonResponse = AjaxUrl( "../PlanFinanciero/Presupuesto.json?registro="+registro );  
    ...
    if (jsonResponse.toString().trim() != "[]")
    {
        ...
        var pafa_presupuesto_id = document.getElementById('pafa_presupuesto_id');        
        pafa_presupuesto_id.value =   objetoJson[0].presupuesto_id ;
        
        var pf1 = document.getElementById('pafa_pf1');        
        pf1.value =   objetoJson[0].pf1 ;
        pf1.value = formatoNumero(pf1.value); 
        pf1.value = formatoPunto(pf1.value);              
        
        var pf2 = document.getElementById('pafa_pf2');        
        pf2.value =   objetoJson[0].pf2 ;
        pf2.value = formatoNumero(pf2.value); 
        pf2.value = formatoPunto(pf2.value);                      
        
        var pf3 = document.getElementById('pafa_pf3');        
        pf3.value =   objetoJson[0].pf3 ;
        pf3.value = formatoNumero(pf3.value); 
        pf3.value = formatoPunto(pf3.value);                      
        
        
        
        var pf4 = document.getElementById('pafa_pf4');        
        pf4.value =   objetoJson[0].pf4 ;
        pf4.value = formatoNumero(pf4.value); 
        pf4.value = formatoPunto(pf4.value);                              
        
        var pf5 = document.getElementById('pafa_pf5');        
        pf5.value =   objetoJson[0].pf5 ;
        pf5.value = formatoNumero(pf5.value); 
        pf5.value = formatoPunto(pf5.value);                              

        
        
        var pf6 = document.getElementById('pafa_pf6');        
        pf6.value =   objetoJson[0].pf6 ;
        pf6.value = formatoNumero(pf6.value); 
        pf6.value = formatoPunto(pf6.value);                                      
        
        
        var pf7 = document.getElementById('pafa_pf7');        
        pf7.value =   objetoJson[0].pf7 ;
        pf7.value = formatoNumero(pf7.value); 
        pf7.value = formatoPunto(pf7.value);                                      
        
        
        var pf8 = document.getElementById('pafa_pf8');        
        pf8.value =   objetoJson[0].pf8 ;
        pf8.value = formatoNumero(pf8.value); 
        pf8.value = formatoPunto(pf8.value);                                              
    
        var pf9 = document.getElementById('pafa_pf9');        
        pf9.value =   objetoJson[0].pf9 ;
        pf9.value = formatoNumero(pf9.value); 
        pf9.value = formatoPunto(pf9.value);                                                      
        
        
        var pf10 = document.getElementById('pafa_pf10');        
        pf10.value =   objetoJson[0].pf10 ;    
        pf10.value = formatoNumero(pf10.value); 
        pf10.value = formatoPunto(pf10.value);                                                      
        
        
        var pf11 = document.getElementById('pafa_pf11');        
        pf11.value =   objetoJson[0].pf11;    
        pf11.value = formatoNumero(pf11.value); 
        pf11.value = formatoPunto(pf11.value);                                                              
        
        
        var pf12 = document.getElementById('pafa_pf12');        
        pf12.value =   objetoJson[0].pf12 ;    
        pf12.value = formatoNumero(pf12.value); 
        pf12.value = formatoPunto(pf12.value);                                                              
