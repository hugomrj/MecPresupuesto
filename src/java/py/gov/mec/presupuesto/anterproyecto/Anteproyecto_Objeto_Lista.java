...
@WebServlet(name = "Anteproyecto_Objeto_Lista", 
        urlPatterns = {"/Anteproyecto/Objeto/Lista"})


public class Anteproyecto_Objeto_Lista extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("pr") != null)
        {
            ...
            List<Map<String, Object>> rows = dao.ObjetoLista(tp, pg, sp, py, pr);
            request.setAttribute("lista", rows);                   
            request.getRequestDispatcher("/Anteproyecto/jspf/ObjetoLista.jspx").include(request, response);        
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Anteproyecto_Objeto_Lista.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
