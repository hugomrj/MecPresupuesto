...
@WebServlet(name = "AnteproyectoJSON", 
        urlPatterns = {"/Anteproyecto/Linea.json"})


public class AnteproyectoJSON extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try 
        {
            ...
            if ( request.getParameter("id") != null) 
            {
                ...
                instancia = (Anteproyecto) persistencia.filtrarId(instancia, codigo);                
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(AnteproyectoJSON.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
