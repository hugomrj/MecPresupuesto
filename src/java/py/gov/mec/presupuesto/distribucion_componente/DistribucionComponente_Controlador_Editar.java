...
@WebServlet(name = "DistribucionComponente_Controlador_Editar", 
        urlPatterns = {"/DistribucionComponente/Controlador/Editar"})



public class DistribucionComponente_Controlador_Editar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            instancia = (DistribucionComponente) persistencia.update(instancia);
