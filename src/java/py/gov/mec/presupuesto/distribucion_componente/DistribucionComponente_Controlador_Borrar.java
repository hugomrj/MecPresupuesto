...
@WebServlet(name = "DistribucionComponente_Controlador_Borrar", 
        urlPatterns = {"/DistribucionComponente/Controlador/Borrar"})



public class DistribucionComponente_Controlador_Borrar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            instancia = (DistribucionComponente) persistencia.delete(instancia);
