...
@WebServlet(name = "Plan_Coleccion_Lista", 
        urlPatterns = {"/Plan/Coleccion/Lista"})


public class Plan_Coleccion_Lista extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("prd2") != null){
            ...
            List<Map<String, Object>> rows = plan.ListaFiltrada( tipo1, tipo2,
                    pg1, pg2, 
                    sp1, sp2, 
                    py1, py2, 
                    obj1, obj2, 
        ...
        request.getRequestDispatcher("/Certificacion/Sub/CollectionLista.jspx").include(request, response);        
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Plan_Coleccion_Lista.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
