...
@WebServlet(name = "DistribucionIngreso_Controlador_Agregar", 
        urlPatterns = {"/DistribucionIngreso/Controlador/Agregar"})



public class DistribucionIngreso_Controlador_Agregar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            instancia = (DistribucionIngreso) persistencia.insert(instancia, request);
            
          
        } catch (Exception ex) {
            Logger.getLogger(DistribucionIngreso_Controlador_Agregar.class.getName()).log(Level.SEVERE, null, ex);
        }
