 ...
 * @author hugo
 */
@WebServlet(name = "DistribucionIngresoMensualJson", 
        urlPatterns = {"/DistribucionIngreso/Mensual.json"})



public class DistribucionIngresoMensualJson extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DistribucionIngresoMensualJson.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
