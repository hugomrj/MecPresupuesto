 ...
 * @author hugo
 */
@WebServlet(name = "CajaChicaDistribucionJSON", 
        urlPatterns = {"/CajaChicaDistribucion/Linea.json"})



public class CajaChicaDistribucionJSON extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(CajaChicaDistribucionJSON.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
