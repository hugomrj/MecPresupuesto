...
@WebServlet(name = "PaisCiudadActionSubConsulta",
        urlPatterns = {"/PaisCiudad/SubConsulta.do"})


public class PaisCiudadActionSubConsulta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        lista.subLineas = 10;
        SessionLista = lista.listaColeccion( new PaisCiudad(), null, strBuscar, pagina );   
       ...
       // request.setAttribute("session_consulta", SessionLista );            
        ...
        request.setAttribute("TotalRegistros", lista.TotalRegistros(new PaisCiudad(), strBuscar) );         
        ...
        request.getRequestDispatcher("/PaisCiudad/Sub/Consulta.jspx").include(request, response);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(PaisCiudadActionSubConsulta.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
