...
@WebServlet(name = "DireccionActionSubConsulta",
        urlPatterns = {"/Direccion/SubConsulta.do"})


public class DireccionActionSubConsulta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Direccion> SessionLista = new ArrayList<Direccion>();
        
        
        
        lista.subLineas = 10;
        SessionLista = lista.listaColeccion( new Direccion(), null, strBuscar, pagina );   
       ...
       // request.setAttribute("session_consulta", SessionLista );            
        ...
        request.setAttribute("TotalRegistros", lista.TotalRegistros(new Direccion(), strBuscar) );         
        ...
        request.getRequestDispatcher("/Direccion/Sub/Consulta.jspx").include(request, response);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DireccionActionSubConsulta.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
