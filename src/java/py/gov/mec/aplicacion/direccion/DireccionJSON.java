...
@WebServlet(name = "DireccionJSON", 
        urlPatterns = {"/Direccion/Linea.json"})


public class DireccionJSON extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try 
        {
            ...
            if ( request.getParameter("id") != null) 
            {
                ...
                instancia = (Direccion) persistencia.filtrarId(instancia, codigo);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DireccionJSON.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
