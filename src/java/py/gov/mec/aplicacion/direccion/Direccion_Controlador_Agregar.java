...
@WebServlet(name = "Direccion_Controlador_Agregar",
        urlPatterns = {"/Direccion/Controlador/Agregar"})


public class Direccion_Controlador_Agregar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            instancia =  (Direccion) persistencia.insert(instancia, request);
