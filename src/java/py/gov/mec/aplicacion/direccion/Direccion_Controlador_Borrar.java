...
@WebServlet(name = "Direccion_Controlador_Borrar",
        urlPatterns = {"/Direccion/Controlador/Borrar"})


public class Direccion_Controlador_Borrar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            instancia =  (Direccion) persistencia.delete(instancia, request);
