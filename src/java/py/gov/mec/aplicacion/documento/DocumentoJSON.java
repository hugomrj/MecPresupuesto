...
@WebServlet(name = "DocumentoJSON", 
        urlPatterns = {"/Documento/Linea.json"})


public class DocumentoJSON extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try 
        {
            ...
            if ( request.getParameter("id") != null) 
            {
                ...
                instancia = (Documento) persistencia.filtrarId(instancia, codigo);
