 ...
 * @author hugo
 */
@WebServlet(name = "IngresoEjecucionSaldoMesJson", 
        urlPatterns = {"/IngresoEjecucion/SaldoMes.json"})



public class IngresoEjecucionSaldoMesJson extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try 
        {
                    ...
                    
            {
                ...
                Gson gson = new Gson ();
                String formatoJSON = gson.toJson(dao.SaldoMes(mes, id, direccion)  );
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(IngresoEjecucionSaldoMesJson.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
