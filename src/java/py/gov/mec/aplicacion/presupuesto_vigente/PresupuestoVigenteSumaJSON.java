 ...
 * @author hugo
 */
@WebServlet(name = "PresupuestoVigenteSumaJSON", 
        urlPatterns = {"/PresupuestoVigente/Suma.json"})



public class PresupuestoVigenteSumaJSON extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try 
        {
            ...
            String formatoJSON = gson.toJson(
                                    dao.Suma(tipo1, tipo2, pg1, pg2, sp1, sp2, 
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(PresupuestoVigenteSumaJSON.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
