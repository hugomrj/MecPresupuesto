...
@WebServlet(name = "PresupuestoVigente_Coleccion_Lista", 
        urlPatterns = {"/PresupuestoVigente/Coleccion/Lista"})


public class PresupuestoVigente_Coleccion_Lista extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("prd2") != null){
            ...
            List<Map<String, Object>> rows = dao.Lista(tipo1, tipo2,
                    pg1, pg2, 
                    sp1, sp2, 
                    py1, py2, 
                    obj1, obj2, 
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(PresupuestoVigente_Coleccion_Lista.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
