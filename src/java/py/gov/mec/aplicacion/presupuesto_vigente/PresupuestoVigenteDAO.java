...
"                            where  1 = 1  "    
    ...
    public List<Map<String, Object>>  Suma  ( Integer tipo1, Integer tipo2, 
                Integer pg1,  Integer pg2, 
                Integer sp1,  Integer sp2,                 
                Integer py1,  Integer py2,    
                Integer obj1,  Integer obj2,    
            ...
            throws Exception {
                ...
                String sql = "   " +
"   Select sum(vigente) suma_vigente, sum(certificado) suma_certificado, sum(diferencia) suma_diferencia  \n" +
"   from ( "+
"                          select *,  (vigente - certificado) diferencia \n" +
"                         from \n" +
"                         ( \n" +
