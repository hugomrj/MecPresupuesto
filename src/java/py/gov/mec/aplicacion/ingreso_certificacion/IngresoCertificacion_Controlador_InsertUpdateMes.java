...
@WebServlet(name = "IngresoCertificacion_Controlador_InsertUpdateMes", 
        urlPatterns = {"/IngresoCertificacion/Controlador/InsertUpdateMes"})



public class IngresoCertificacion_Controlador_InsertUpdateMes extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            Logger.getLogger(IngresoCertificacion_Controlador_InsertUpdateMes.class.getName()).log(Level.SEVERE, null, ex);
            out.println( "0");            
        }
